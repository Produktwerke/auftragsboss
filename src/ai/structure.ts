  ...
  raeumeText: z
    ...
    .describe(
      "Räume mit diktierten Maßen, EINE Zeile je Raum, exakt in diesem Format: " +
        ...
        "Decke: ja nur, wenn die Decke bearbeitet wird; oder direkt die genannte Fläche ('Decke: 14'); oder das Grundmaß des Raums ('Decke: 3,98 x 3,50'), wenn in Wände nicht alle vier Wände stehen. Öffnungen: nur mit diktierter Breite UND Höhe, sonst 'keine'. " +
...
5. **Arbeitsleistungen sind standardmäßig eine Pauschale.** Jede Position mit kategorie LEISTUNG bekommt einheit "pauschal" und menge 1 — ES SEI DENN, für genau diese Leistung wurde ausdrücklich eine Menge samt Einheit diktiert (z.B. "45 Quadratmeter Decke streichen", "6 Stunden", "12 laufende Meter Sockelleiste"). Nur dann übernimm die genannte Menge und Einheit. Leite für Arbeitsleistungen NIEMALS Quadratmeter, Stück o.ä. aus Raummaßen ab — der Handwerker kalkuliert die Leistung als Ganzes und trägt einen Pauschalpreis ein. Alle Maße aus dem Diktat gehören nach "aufmassNotizen", nicht in die Positionsmenge. Bei pauschalen Leistungen bleibt "mengeUnsicher" false.
   ...
   **Nicht alle Wände werden gestrichen** (z.B. "eine Wand hat Paneele, nur drei Wände"): In "Wände" stehen NUR die zu streichenden Wandlängen (z.B. "Wände: 3,98, 3,50, 3,98"). Damit die Decke trotzdem berechnet wird, steht dann das Grundmaß des Raums bei der Decke: "Decke: 3,98 x 3,50" (die beiden diktierten Raumseiten, nichts rechnen). "Decke: ja" reicht nur, wenn "Wände" genau die zwei Seiten des Rechtecks enthält.
...
5. ${materialRegel(preisliste.konditionen.materialGetrennt)}
   - RÄUME (sobald raeumeText mindestens eine Raumzeile hat, auch bei nur EINEM Raum): Das Angebot wird dem Kunden je Raum gegliedert (Raum als Überschrift, Positionen 1.1, 1.2 …). Deshalb bekommt JEDE Leistung ihren raumBezug; der Raumname steht NICHT zusätzlich in der Beschreibung. Raumübergreifendes (Abdecken, Anfahrt, Baustelleneinrichtung, Entsorgung) ohne raumBezug.
