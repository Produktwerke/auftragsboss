...
export const DIREKT_GELESENE_SCHLUESSEL = [
  ...
  "AGB_URL", "AVV_URL", "AGB_VERSION", "STRIPE_AGB_HAEKCHEN", "AGB_GATE", "DATENSCHUTZ_URL",
  "SALESFRANK_WEBHOOK_SECRET", "LEAD_VORLAGE_NEUTRAL",
  "LEAD_VORLAGE_ERKLAERUNG", "LEAD_VORLAGE_AUFFORDERUNG", "WHATSAPP_WABA_ID",
] as const;
